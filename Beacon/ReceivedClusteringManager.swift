...
public protocol ReceivedClusteringManagerDelegate {
    ...
    func cellSizeFactorForCoordinator(_ coordinator:ReceivedClusteringManager) -> CGFloat
    
}

open class ReceivedClusteringManager : NSObject {
    
    open var delegate:ReceivedClusteringManagerDelegate? = nil
